...
adArea_div.style.background = "linear-gradient(0deg, black 3%, white 3%, white 5%, white 5%, white 5%, white 5%, white)";
adArea_div.style.backgroundSize = "5px 30px";
...
swiperButtonNext.src = 'arrow-min.png';
...
swiperButtonPrev.src = 'arrow-min.png';
...
ninja_ad_items.slice(1, 5).forEach((item) => {
	...
	p_textarea.style.position = "absolute";
	p_textarea.style.paddingLeft = "20px";
	p_textarea.style.paddingRight = "20px";
	p_textarea.style.textAlign = "center";
	p_textarea.style.color = "#4285F4";
	p_textarea.style.fontSize = "13px";
	p_textarea.style.margin = "0px";
	...
	div_textarea.appendChild(p_textarea);
	class_num++;
})
